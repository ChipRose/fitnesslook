const settingAccordion = (props) => ({ duration: 400, ...props });

const settingAccordionInSlider = (slider, props) => ({ duration: 200, onOpen: () => slider.updateSliderHeight(), onClose: () => slider.updateSliderHeight(), ...props });
