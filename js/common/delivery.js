...
document.querySelector('#slider-table') && document.querySelector('#slider-table-buttons') && setTableSlider('#slider-table', {
  controlsContainer: '#slider-table-buttons'
})

document.querySelector('#slider-table-no-elevator') && document.querySelector('#slider-table-buttons-no-elevator') && setTableSlider('#slider-table-no-elevator', {
  controlsContainer: '#slider-table-buttons-no-elevator'
})

document.querySelector('#pickup-slider') && document.querySelector('#pickup-slider-buttons') && setSlider('#pickup-slider', {
