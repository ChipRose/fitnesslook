...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var DateFormatter;
!function () {
  "use strict";
...
!function (e) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
...
/* harmony import */ var jquery_datetimepicker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(() => {
  ...
  const handleTabClick = function () {
    const tabId = jquery__WEBPACK_IMPORTED_MODULE_0__(this).data('tab');
    jquery__WEBPACK_IMPORTED_MODULE_0__('.tab-menu__item').removeClass('tab-menu__item--active');
    jquery__WEBPACK_IMPORTED_MODULE_0__('.tab-content__item').removeClass('tab-content__item--active');
    jquery__WEBPACK_IMPORTED_MODULE_0__(this).addClass('tab-menu__item--active');
    jquery__WEBPACK_IMPORTED_MODULE_0__(`#${tabId}`).addClass('tab-content__item--active');
    const container = jquery__WEBPACK_IMPORTED_MODULE_0__('.tab-menu');
    const scrollLeft = container.scrollLeft();
    const buttonOffset = jquery__WEBPACK_IMPORTED_MODULE_0__(this).offset().left - container.offset().left + scrollLeft;
    container.animate({
      scrollLeft: buttonOffset - container.width() / 2 + jquery__WEBPACK_IMPORTED_MODULE_0__(this).outerWidth() / 2
    }, 300);
  };
  jquery__WEBPACK_IMPORTED_MODULE_0__('.tab-menu__item').on('click', handleTabClick);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('#form-sertificate').on('submit', event => {
    event.preventDefault();
    const formData = jquery__WEBPACK_IMPORTED_MODULE_0__('#form-sertificate').serialize();
    jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
      type: 'POST',
      url: '/callme.php',
      data: formData,
      success: () => {
        jquery__WEBPACK_IMPORTED_MODULE_0__('#form-sertificate')[0].reset();
        onSuccess();
      },
      error: () => {
        onError();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', event => {
    if (jquery__WEBPACK_IMPORTED_MODULE_0__(event.target).closest('#modal-success').length === 0 && modalSuccess.open) {
      closeModalSuccess();
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', event => {
    if (jquery__WEBPACK_IMPORTED_MODULE_0__(event.target).closest('#modal-error').length === 0 && modalError.open) {
      closeModalError();
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#modal-success', event => {
    event.stopPropagation();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0__(document).on('click', '#modal-error', event => {
    event.stopPropagation();
  });
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__.datetimepicker.setLocale('ru');
  jquery__WEBPACK_IMPORTED_MODULE_0__('input[name="date"]').datetimepicker({
    format: 'd-m-Y',
    timepicker: false,
    lang: 'ru',
    scrollMonth: false,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0__('input[name="time"]').datetimepicker({
    format: 'H:i',
    datepicker: false,
    step: 30,
    minTime: '11:00',
