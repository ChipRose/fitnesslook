...
document.querySelector('#slider-table') && document.querySelector('#slider-table-buttons') && (0,_delivery_slider_js__WEBPACK_IMPORTED_MODULE_11__.setTableSlider)('#slider-table', {
  controlsContainer: '#slider-table-buttons'
});
document.querySelector('#slider-table-no-elevator') && document.querySelector('#slider-table-buttons-no-elevator') && (0,_delivery_slider_js__WEBPACK_IMPORTED_MODULE_11__.setTableSlider)('#slider-table-no-elevator', {
  controlsContainer: '#slider-table-buttons-no-elevator'
});
document.querySelector('#pickup-slider') && document.querySelector('#pickup-slider-buttons') && (0,_delivery_slider_js__WEBPACK_IMPORTED_MODULE_11__.setSlider)('#pickup-slider', {
